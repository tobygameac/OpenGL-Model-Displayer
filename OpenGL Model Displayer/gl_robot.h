...
namespace OpenGLModelDisplayer {
  ...
  public:
    ...
    void Idle(const float delta_time) {
      head_mesh_node_->RotateMesh(glm::radians(45.0f * (delta_time / 1000.0f)), glm::vec3(0, 1, 0));
      left_upper_arm_mesh_node_->RotateMesh(glm::radians(90.0f * (delta_time / 1000.0f)), glm::vec3(1, 0, 0));
      right_lower_arm_mesh_node_->RotateMesh(glm::radians(60.0f * (delta_time / 1000.0f)), glm::vec3(0, 1, 0));
      right_upper_leg_mesh_node_->RotateMesh(glm::radians(30.0f * (delta_time / 1000.0f)), glm::vec3(0, 1, 0));
    }
          ...
          while (std::getline(mtl_file_stream, line_buffer)) {
            ...
            if (line_header == "newmtl") {
              ...
              if (material_name == "head") {
                ...
                GLTexture::SetGLTexture(cv::imread(file_folder_path + texture_file_path), left_upper_arm_mesh_node_->GetMeshTextureId());
                GLTexture::SetGLTexture(cv::imread(file_folder_path + texture_file_path), left_lower_arm_mesh_node_->GetMeshTextureId());
                GLTexture::SetGLTexture(cv::imread(file_folder_path + texture_file_path), right_upper_arm_mesh_node_->GetMeshTextureId());
                GLTexture::SetGLTexture(cv::imread(file_folder_path + texture_file_path), right_lower_arm_mesh_node_->GetMeshTextureId());
                GLTexture::SetGLTexture(cv::imread(file_folder_path + texture_file_path), left_upper_leg_mesh_node_->GetMeshTextureId());
                GLTexture::SetGLTexture(cv::imread(file_folder_path + texture_file_path), left_lower_leg_mesh_node_->GetMeshTextureId());
                GLTexture::SetGLTexture(cv::imread(file_folder_path + texture_file_path), right_upper_leg_mesh_node_->GetMeshTextureId());
                GLTexture::SetGLTexture(cv::imread(file_folder_path + texture_file_path), right_lower_leg_mesh_node_->GetMeshTextureId());
              }
              // temp
