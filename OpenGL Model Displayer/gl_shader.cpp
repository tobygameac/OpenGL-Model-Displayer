...
const std::string DEFAULT_SHADER_ATTRIBUTE_VERTEX_NORMAL_NAME = "vertex_normal";
...
const std::string DEFAULT_SHADER_UNIFORM_INVERSE_MODELVIEW_MATRIX_NAME = "inverse_modelview_matrix";
const std::string DEFAULT_SHADER_UNIFORM_TRANSPOSE_INVERSE_MODELVIEW_MATRIX_NAME = "transpose_inverse_modelview_matrix";
...
GLShader::GLShader(const std::string &vertex_shader_file_path,
  ...
  const std::string &shader_attribute_vertex_normal_name,
  ...
  const std::string &shader_uniform_inverse_modelview_matrix_name,
  const std::string &shader_uniform_transpose_inverse_modelview_matrix_name,
  ...
  shader_attribute_vertex_normal_id_ = glGetAttribLocation(shader_program_id_, shader_attribute_vertex_normal_name.c_str());
  if (shader_attribute_vertex_normal_id_ == -1) {
  ...
  shader_uniform_inverse_modelview_matrix_id_ = glGetUniformLocation(shader_program_id_, shader_uniform_inverse_modelview_matrix_name.c_str());
  if (shader_uniform_inverse_modelview_matrix_id_ == -1) {
    std::cerr << "Could not bind uniform " << shader_uniform_inverse_modelview_matrix_name << ".\n";
  }

  shader_uniform_transpose_inverse_modelview_matrix_id_ = glGetUniformLocation(shader_program_id_, shader_uniform_transpose_inverse_modelview_matrix_name.c_str());
  if (shader_uniform_transpose_inverse_modelview_matrix_id_ == -1) {
...
void GLShader::CreateDefaultShader() {
  *this = GLShader(DEFAULT_VERTEX_SHADER_FILE_PATH,
    ...
    DEFAULT_SHADER_ATTRIBUTE_VERTEX_NORMAL_NAME,
    ...
    DEFAULT_SHADER_UNIFORM_INVERSE_MODELVIEW_MATRIX_NAME,
    DEFAULT_SHADER_UNIFORM_TRANSPOSE_INVERSE_MODELVIEW_MATRIX_NAME,
